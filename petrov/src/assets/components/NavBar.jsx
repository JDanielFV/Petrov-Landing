...
const Navbar = () => {
  ...
  return (
    <NavbarContainer>
      ...
      <NavLinks>
        <NavLink onClick={() => scrollToSection('sobre-nosotros')}>Conócenos</NavLink>
        <NavLink onClick={() => scrollToSection('servicios')}>Servicios</NavLink>
        <NavLink onClick={() => scrollToSection('cursos')}>Cursos</NavLink>
        <NavLink onClick={() => scrollToSection('promo-app')}>Nuestra App</NavLink>
      ...
      <MobileMenu isOpen={menuOpen}>
        <MobileNavLinks>
          <NavLink onClick={() => { scrollToSection('sobre-nosotros'); toggleMenu(); }}>Conócenos</NavLink>
          <NavLink onClick={() => { scrollToSection('servicios'); toggleMenu(); }}>Servicios</NavLink>
          <NavLink onClick={() => { scrollToSection('cursos'); toggleMenu(); }}>Cursos</NavLink>
          <NavLink onClick={() => { scrollToSection('promo-app'); toggleMenu(); }}>Nuestra App</NavLink>
