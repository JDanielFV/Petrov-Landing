...
const Servicios = () => {
  return (
    <>
      <ServicioContainer src="./src/assets/images/evaluacion.jpg" color='90deg, rgba(101,9,9,1) 0%, rgba(255,255,255,0) 100%' alignItems='star'>
        <ServicioTexto>
      ...
      <ServicioContainer src="../src/assets/images/diseno.webp" color='270deg, rgba(101,9,9,1) 0%, rgba(255,255,255,0) 100%' alignItems='end'>
        <ServicioTexto>
      ...
      <ServicioContainer src="../src/assets/images/capacitacion.jpg" color='90deg, rgba(101,9,9,1) 0%, rgba(255,255,255,0) 100%' alignItems='start'>
        <ServicioTexto>
      ...
      <ServicioContainer src="../src/assets/images/mantenimiento.jpg" color='270deg, rgba(101,9,9,1) 0%, rgba(255,255,255,0) 100%' alignItems='end'>
        <ServicioTexto>
